  ...
  <div class="layui-header">
    ...
    <ul class="layui-nav layui-layout-right">
      <li class="layui-nav-item">
        <a href="javascript:;"><img src="../public/image/admin.png" class="layui-nav-img">系统管理员</a>
  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item" id="updatePassword"><a href="javascript:;" target="content"><i class="layui-icon layui-icon-util" style="font-size: 16px; color: #1E9FFF;"> </i>密码修改</a></li>
      </ul>
    </div>
  </div>
