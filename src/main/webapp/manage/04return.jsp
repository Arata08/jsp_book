...
<jsp:useBean id="judge" scope="session" class="javabean.JDBCBean"></jsp:useBean>
	...
	<div align="center"
		style="margin-left:30%; margin-top: 2%; width: 40%;">
		...
		<form class="layui-form layui-form-pane" action="05returnSus.jsp">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					...
					<input type="text" name="date1" id="date1" autocomplete="off" value="<%=formatter.format(date)%>"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="ill" value="<%=session.getAttribute("mes") %>"
